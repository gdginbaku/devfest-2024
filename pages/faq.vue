...
useSeoMeta({
  ...
  ogImage: `${mainData.seo.hostUrl}/thumbnail.jpg?auto=format&fit=crop&frame=1&h=512&w=1024`,
  ...
  twitterImage: `${mainData.seo.hostUrl}thumbnail.jpg?auto=format&fit=crop&frame=1&h=512&w=1024`,
